...
class QueryProcessor:
	def __init__(self, query, model, raw_corpus_path, processed_corpus_path):
		self.model = model
	...
	def tokenize(self):
		self.query_tokens = w_tokenizer(query)
...
if __name__=='__main__':
	...
	while (1):
		...
		qp = QueryProcessor(query, model, raw_corpus_path, processed_corpus_path)
		ans = qp.search()
		print(ans)